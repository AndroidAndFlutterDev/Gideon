...
while True:
    ...
    if status:
        if 'estas ahi' in rec:
            ...
            speak("Julian Principe, por supuesto. Futuro experto desarrollador de Inteligencia Artificial y Robótica, experto en pyton, y tecnologías como Ardruino. Experto en Deep Learning, y sus respectivas areas(que forman parte del generico Machine Learning, como: el NLP, Vision Artificial, Robotica, todo lo que son las Redes Neuronales y sus tipos. apasionado por la IA generativa, los Word Models, etc).AH, y mi programador.")
