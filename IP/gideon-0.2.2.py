...
while True:
    ...
    if status:
        if 'estas ahi' in rec:
            ...
            speak("Julian Principe, por supuesto. Futuro experto programador de Inteligencia Artificial, experto en python. AH, y mi programador.")
            ...
            speak("Bueno, no es necesario insultar.¿Quieres que te cuente uno mejor?")
