...
while True:
    ...
    if status:
        if 'estas ahi' in rec:
            ...
            speak("Julian Principe, por supuesto. Futuro experto Desarrollador de Aplicaciones Moviles, tanto Android, como iOS, experto en tecnologias como Flutter, Swift, Dart, y Kotlin. Logica de Programacion impecable, y gran conocedor de las leyes UX/UI, y Frameworks para Apps Multiplataforma, como Kotlin Multi Platform, y el antes mencionado Flutter. Su objetivo principal es convertirse en un Senior Developer en Flutter, por todas las razones que tiene este Framework para ser espectacular, satisfactorio, atractivo, y simple a la vez. Ah, y mi Programador.")
            ...
            speak("marina becerra es una sociologa, investigadora y profesora. Es madre de un gran geografo y un futuro experto desarrollador de  aplicaciones moviles.")
          ...
          ruta_bloque_notas = f"RUTA_A_TU_BLOQUE_DE_NOTAS/{nombre_bloque_notas}"  # Reemplaza con la ruta correcta
