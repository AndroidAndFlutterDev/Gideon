...
while True:
    ...
    if status:
        if 'estas ahi' in rec:
            ...
            speak("Julian Principe, por supuesto. Futuro experto desarrollador de Inteligencia Artificial, experto en pyton, Deep Learning, y sus respectivas areas(que forman parte del generico Machine Learning, como: el NLP, reconocimiento de voz, Vision Artificial, Robotica, todo lo que son las Redes Neuronales y sus tipos. apasionado por la IA generativa, los Word Models, etc).AH, y mi programador.")
            ...
            speak("Vicente es el hijo de Luis Maria Pescetti, muy creativo, sadico, y tiene un autocontrol muy significativo respecto a su ira, no a ser molesto.")
            ...
            speak("marina becerra es una sociologa, investigadora y profesora. Es madre de un gran geografo y un futuro experto desarrollador de ia.")
